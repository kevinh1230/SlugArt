...
db.define_table('gallery',
    Field('uploader',default = get_username()),
...
db.define_table('post',
    Field('imageid', 'reference gallery'),
    Field('author', default = get_username()),
    Field('body', 'text'))

db.gallery.title.requires = IS_NOT_IN_DB(db, db.gallery.title)
db.gallery.time.writable = False
db.gallery.file.requires = IS_NOT_EMPTY()
db.gallery.uploader.writable = False
db.gallery.time.readable = db.gallery.time.writable = False
db.gallery.tag.requires=IS_IN_SET(['Digital Art','Traditional Art','Photography','Anime and Manga','Cartoons','Scraps','Fan Art'])
db.gallery.tag.label = "Category"
db.gallery.likes.readable = db.gallery.likes.writable = False

db.post.imageid.requires = IS_IN_DB(db, db.gallery.id, '%(title)s')
db.post.author.requires = IS_NOT_EMPTY()
db.post.body.requires = IS_NOT_EMPTY()
db.post.imageid.writable = db.post.imageid.readable = False
